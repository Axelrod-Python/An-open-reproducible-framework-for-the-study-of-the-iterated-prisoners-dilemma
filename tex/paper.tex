...
With a growing collection of 135 strategies, the library is a also a
...
match generator class (in the \texttt{match\_generator.py} module) which is
designed in such a way as to be easily modifiable to create new types of
tournaments. This is described fuller in a tutorial in the documentation which
shows how to easily create a tournament where players only play each other with
probability 0.5.  This will be discussed further in the reuse section of this
paper.
