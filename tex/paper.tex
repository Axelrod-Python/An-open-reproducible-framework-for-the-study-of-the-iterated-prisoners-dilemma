...
\usepackage[backend=bibtex, firstinits=true, url=false, isbn=true]{biblatex}
...
automatically using \url{travis-ci.org}). Thus, when submitting a strategy, a
...
\begin{figure}[!hbtp]
    ...
    \caption{Results from the library tournament (2016-06-01)}
