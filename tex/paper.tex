...
popular language in the academic community with libraries developed for:
...
In \cite{Isaac2008} Python is described as an appropriate language for the
...
\url{https://github.com/Axelrod-Python/Axelrod}. This is a hosted git repository
which. Git is a popular version control system which is one of the recommended
aspects of reproducible research \cite{Crick2014a, Sandve2013}.

Figure~\ref{fig:demo_tournament_commands} shows a very simple example of using
the library to create a basic tournament with the graphical output shown in
