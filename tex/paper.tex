...
Figure~\ref{fig:overview}. Add:

\begin{itemize}
	\item Discuss match generators (possibly include in image?)
	\item Discuss what a strategy is (class, inheritance).
	\item Reuse (possibility of creating new tournament types).
\end{itemize}
