...
reproducibility of research in to the iterated prisoner's dilemma. Through the
very nature of the development of this library, all open research and
development, it has not only acquired a large number of strategies (120) but
also already discovered various insights that will lead to further publications.
