...
You can see an overview of the structure of the source code in Figure~\ref{fig:overview}.
...
The current winning strategy is a novel strategy called: Looker Up. This
...
Intuitively, this state space uses the initial plays of the opponent to gain
some information about its intentions whilst still taking in to account the
recent play. The actual winning strategy is an instance of the framework for
...
At
\url{http://vknight.org/unpeudemath/gametheory/2015/11/28/Experimenting-with-a-high-performing-evolved-strategy-in-other-environments/}
experiments are described that evaluate how this particular strategy behaves in
environments other than those in which it was trained\dots
...
Details for the above can be found at \url{http://marcharper.codes/}.
