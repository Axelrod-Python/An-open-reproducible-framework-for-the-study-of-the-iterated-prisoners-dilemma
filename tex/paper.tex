...
% Core devs (alphabetic order of last name)
\author[1]{Owen Campbell}
\author[1]{Mark Harper}
\author[2]{Vincent Knight}
\author[1]{Karol Langner}

% All devs (alphabetic order of last name)
\author[2]{James Campbell}
\author[5]{Thomas Campbell}
\author[2]{Alex Carney}
\author[2]{Martin Chorley}
\author[1]{Cameron Davidson-Pilon}
\author[1]{Kristian Glass}
\author[1]{Tom{\'a}{\v s} Ehrlich}
\author[1]{Martin Jones}
\author[4]{Georgios Koutsovoulos}
\author[1]{Holly Marissa}
\author[1]{Jochen M{\"u}ller}
\author[2]{Geraint Palmer}
\author[3]{Paul Slavin}
\author[2]{Timothy Standen}
\author[1]{Luis Visintini}
\author[1]{Karl Molden}

% Affiliations
\affil[1]{Not affiliated}
\affil[2]{Cardiff University}
\affil[3]{The University of Manchester}
\affil[4]{The University of Edinburgh}
\affil[5]{St. Nicholas Catholic High School, Hartford}
...
\maketitle
\begin{center}
    \thanks{Corresponding author: Vincent Knight
        \href{mailto:knightva@cf.ac.uk}{knightva@cf.ac.uk}}
\end{center}
...
\section{Overview}\label{sec:sec:overview}
...
As stated in Section~\ref{sec:sec:overview}, one of the main goals of the library
...
\subsection{New strategies, tournaments and implications}\label{sec:new-strategies-and-implications}
...
This library has the potential to be a common standard for research in to the
iterated Prisoner's dilemma. In particular, having a large library of
tested strategies readily available for experimentation is of high value to the
research community.

This has been evidenced by the work described in
Section~\ref{sec:new-strategies-and-implications} the library has already shown
