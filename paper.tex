...
example in~\cite{Stephens2002}, a real tournament where Blu Jays are the
...
given in Table~\ref{tab:tournament}.

\begin{table}[!hbtp]
    \begin{center}
        \begin{tabular}{ccccc}
            \toprule
            Year & Reference            & Number of Strategies & Type     & Reproducible\\
            \midrule
            1979 & \cite{Axelrod1980a}  & 13                   & Standard & With difficulty\\
            1979 & \cite{Axelrod1980b}  & 64                   & Standard & With difficulty\\
            \bottomrule
        \end{tabular}
    \end{center}
